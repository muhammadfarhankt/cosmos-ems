...
import (
	...
	ems "github.com/rollchains/hackmoschain/x/ems"
	emskeeper "github.com/rollchains/hackmoschain/x/ems/keeper"
	emstypes "github.com/rollchains/hackmoschain/x/ems/types"
...
const (
	appName      = "hackmoschain"
	NodeDir      = ".hackmoschain"
	Bech32Prefix = "hackmos"
)
...
func NewChainApp(
	...
	addressCodec := address.NewBech32Codec(Bech32Prefix) // Initialize addressCodec

	// Create the ems Keeper
	// app.EmsKeeper = emskeeper.NewKeeper(
	// 	appCodec,
	// 	addressCodec, // Pass addressCodec
	// 	keys[emstypes.StoreKey],
	// 	app.GetSubspace(emstypes.ModuleName),
	// 	app.NFTKeeper, // Pass NFTKeeper
	// )
	...
	app.EmsKeeper = emskeeper.NewKeeper(
		appCodec,
		addressCodec,
		runtime.NewKVStoreService(keys[emstypes.StoreKey]), // Use NewKVStoreService
	...
	app.ModuleManager = module.NewManager(
		...
		ems.NewAppModule(appCodec, app.EmsKeeper),
	)
	...
	// see cmd/hackmosd/root.go: 206 - 214 approx
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey storetypes.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(emstypes.ModuleName)
