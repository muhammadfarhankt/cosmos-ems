...
// 				{
// 					RpcMethod: "CreateEvent",
// 					Use:       "create [name] [description] [location] [date] [time] [ticket_price] [num_tickets] [ticket_categories]",
// 					Short:     "Create an event",
// 					PositionalArgs: []*autocliv1.PositionalArgDescriptor{
// 						{ProtoField: "name"},
...
// 						{ProtoField: "num_tickets", ProtoType: "uint64"},
// 						{ProtoField: "ticket_categories", ProtoType: "string", IsRepeated: true},
// 					},
// 				},
